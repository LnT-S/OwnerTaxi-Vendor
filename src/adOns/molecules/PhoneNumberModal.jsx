...
export default function PhoneNumberModal(props) {
    ...
    const { show, setShow, title, phoneArray , setPhone } = props
                ...
                <View style={{ ...styles.modalContent, ...props.extContStyle }}>
                    ...
                    <View style={styles.modalContentScreen}>
                        {phoneArray.map((item, index) => {
                            ...
                            onPress={()=>{setPhone(item.phoneNumber);setShow(false)}}
                            >
                                <Text style={{color : 'black' , fontSize  : 22 , fontWeight: '500',textAlign : 'center'}}>{item.phoneNumber}</Text>
                            </TouchableOpacity>
                        })}
                    </View>
